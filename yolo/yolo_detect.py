# From https://raw.githubusercontent.com/EdjeElectronics/Train-and-Deploy-YOLO-Models/refs/heads/main/yolo_detect.py
import os
import sys
import argparse
import glob
...
if not os.path.exists(model_path):
    print(
        "WARNING: Model path is invalid or model was not found. Using default yolov8s.pt model instead."
    )
